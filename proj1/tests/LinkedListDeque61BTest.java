...
public class LinkedListDeque61BTest {
    ...
    public void isEmptyTest() {
         ...
         lld1.addLast(0);
         lld1.addLast(1);
         assertThat(lld1.toList().isEmpty()).isEqualTo(false);
    ...
    public void sizeTest() {
         ...
         lld1.addLast(0);
         lld1.addLast(1);
         assertThat(lld1.toList().size()).isEqualTo(2);
    ...
    public void getFirstTest() {
         ...
         lld1.addLast(0);
         lld1.addLast(1);
         assertThat(lld1.getFirst()).isEqualTo(0);
    ...
    public void getTest() {
        ...
        assertThat(lld1.get(12345)).isEqualTo(null);
    ...
    public void getRecursiveTest() {
        ...
        assertThat(lld1.getRecursive(12345)).isEqualTo(null);
